...
import Equipments from "@/components/GridItems/Equipments";
...
const RightPanel = () => {
  ...
  return (
    <div
      ref={scope}
      className="grid w-full grid-cols-4 xl:gap-10 gap-6 xl:py-10 py-6 xl:px-2 xl:overflow-y-auto auto-rows-[76px]"
    >
